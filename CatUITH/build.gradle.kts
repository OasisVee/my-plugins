...
aliucord.changelog.set(
    """
    # 1.4.1
    * Removed add and current commands and the regex setting for retrieval link since this plugin actually does not support other hosts anymore
    ...
    * added /cuith clearhistory and a clear history button in settings
