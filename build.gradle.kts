...
subprojects {
    ...
    aliucord {
        author("._.serinova._.", 967152107922792478L)
        updateUrl.set("https://raw.githubusercontent.com/OasisVee/my-plugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/OasisVee/my-plugins/builds/%s.zip")
    }
